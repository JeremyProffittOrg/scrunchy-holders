...
DESIGNS = [
    ("r2d2-01-classic", "r2d2_holders.scad", 1, "R2-D2", "Classic Astromech",
     "White barrel, blue door plates, skirt vents, radar eye, and dome tools."),
    ("r2d2-02-field-unit", "r2d2_holders.scad", 2, "R2-D2", "Field Unit with Legs",
     "Astromech body with hip, shin, foot treads, and a front caster."),
    ("r2d2-03-dome-heavy", "r2d2_holders.scad", 3, "R2-D2", "Dome-Heavy Unit",
     "Short fat barrel and a large instrument dome with radar and panels."),
    ("r2d2-04-panel-tank", "r2d2_holders.scad", 4, "R2-D2", "Panel Tank",
     "Square body with inset door plates, utility hatch, and a dome."),
    ("r2d2-05-slim", "r2d2_holders.scad", 5, "R2-D2", "Slim Astromech",
     "Tall stack of instrument belts, utility hatch, and a small dome."),
